<template>
    <a-form :model="formState" @finish="handleCreateToken">
        <a-form-item label="令牌名称" name="name" :rules="[{ required: true }]">
            <a-input
    ...
    <a-table :columns="columns" :data-source="tokens" :loading="loading">
